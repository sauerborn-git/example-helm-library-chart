...
*/}}
{{- define "examplelibrarychart.name" -}}
...
*/}}
{{- define "examplelibrarychart.fullname" -}}
...
Selector labels
*/}}
{{- define "examplelibrarychart.selectorLabels" -}}
app.kubernetes.io/name: {{ include "examplelibrarychart.name" . }}
